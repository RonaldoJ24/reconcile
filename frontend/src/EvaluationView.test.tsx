...
describe('EvaluationView', () => {
  it('renders server packaged values and explicit v2 unknown state', () => {
    ...
    expect(plainMarkup).toContain('Independent domain review: Pending')
    expect(plainMarkup).toContain('Provider calls in this continuation: 0')
    expect(plainMarkup).toContain('Final access in this continuation: No')
